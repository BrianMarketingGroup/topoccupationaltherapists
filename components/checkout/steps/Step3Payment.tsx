...
// topaudiologists' own applySchema collects only billingZip, not a full
// billing address — this step intentionally omits billingAddress/City/State
// fields present in the classic wizard template.
